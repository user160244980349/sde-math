...
def t2p5():
    ...
    for dt in dts:
        print(f"dt = {dt},\n\n"
              ...
              f"\tq2 [01]        = {q_01_12(dt ** 3)}\n"
              f"\tq2 [01] (2, 1) = {q_01_21(dt ** 3)}\n"
              f"\tq2 [10]        = {q_10_12(dt ** 3)}\n"
              f"\tq2 [10] (2, 1) = {q_10_21(dt ** 3)}\n\n"
