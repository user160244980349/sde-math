...
def t2p5():
    ...
    for dt in dts:
        print(f"dt = {dt},\n\n"
              ...
              f"\tq3 [001] = {q_001(dt ** 2)},\n"
              f"\tq3 [001] (1, 2) = {q_001_12(dt ** 2)},\n"
              f"\tq3 [001] (1, 3) = {q_001_13(dt ** 2)},\n"
              f"\tq3 [001] (2, 3) = {q_001_23(dt ** 2)},\n"
              f"\tq3 [010] = {q_10_12(dt ** 2)},\n"
              f"\tq3 [010] (1, 2) = {q_010_12(dt ** 2)},\n"
              f"\tq3 [010] (1, 3) = {q_010_13(dt ** 2)},\n"
              f"\tq3 [010] (2, 3) = {q_010_23(dt ** 2)},\n"
              f"\tq3 [100] = {q_10_12(dt ** 2)},\n"
              f"\tq3 [100] (1, 2) = {q_100_12(dt ** 2)},\n"
              f"\tq3 [100] (1, 3) = {q_100_13(dt ** 2)},\n"
              f"\tq3 [100] (2, 3) = {q_100_23(dt ** 2)},\n\n"
              ...
              f"\tiv.2   q4 (1, 3) (3, 4, 5) = {q_00000_12_345(dt)},\n"
              f"\tiv.3   q4 (1, 4) (3, 4, 5) = {q_00000_12_345(dt)},\n"
              f"\tiv.4   q4 (1, 5) (3, 4, 5) = {q_00000_12_345(dt)},\n"
              f"\tiv.5   q4 (2, 3) (3, 4, 5) = {q_00000_12_345(dt)},\n"
              f"\tiv.6   q4 (2, 4) (3, 4, 5) = {q_00000_12_345(dt)},\n"
              f"\tiv.7   q4 (2, 5) (3, 4, 5) = {q_00000_12_345(dt)},\n"
              f"\tiv.8   q4 (3, 4) (3, 4, 5) = {q_00000_12_345(dt)},\n"
              f"\tiv.9   q4 (3, 5) (3, 4, 5) = {q_00000_12_345(dt)},\n"
              f"\tiv.10  q4 (4, 5) (3, 4, 5) = {q_00000_12_345(dt)},\n"
