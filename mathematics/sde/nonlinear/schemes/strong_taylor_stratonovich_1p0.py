...
from ..functions.schemes.StrongTaylorStratonovich1p0 import StrongTaylorStratonovich1p0
...
def strong_taylor_stratonovich_1p0(y0: np.array, a: sp.Matrix, b: sp.Matrix, q: int, times: tuple):
    ...
    start_time = time()
    print("--------------------------")
    print("[%.3f seconds] Start Strong Taylor-Stratonovich 1.0" % (time() - start_time))
