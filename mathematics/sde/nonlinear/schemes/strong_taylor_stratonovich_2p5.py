...
from ..functions.schemes.StrongTaylorStratonovich2p5 import StrongTaylorStratonovich2p5
...
def strong_taylor_stratonovich_2p5(y0: np.array, a: sp.Matrix, b: sp.Matrix,
    ...
    start_time = time()
    print("--------------------------")
    print("[%.3f seconds] Start Strong Taylor-Stratonovich 2.5" % (time() - start_time))
    ...
    y = StrongTaylorStratonovich2p5(sym_i, sym_yp, sym_a, sym_b,
