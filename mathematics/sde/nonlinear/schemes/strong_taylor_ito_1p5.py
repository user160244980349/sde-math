...
from mathematics.sde.nonlinear.functions.schemes.StrongTaylorIto1p5 import StrongTaylorIto1p5


def strong_taylor_ito_1p5(y0: np.array, a: sp.Matrix, b: sp.Matrix,
    ...
    start_time = time()
    print("--------------------------")
    print(f"[{(time() - start_time):.3f} seconds] Start Strong Taylor-Ito 1.5")
    ...
    y = StrongTaylorIto1p5(sym_i, sym_yp, sym_a, sym_b,
