...
from ..stratonovich.J2 import J2
...
from ..stratonovich.J100 import J100
from ..stratonovich.J010 import J010
from ..stratonovich.J001 import J001
from ..stratonovich.J0000 import J0000
from ..stratonovich.J00000 import J00000
from ..L import L
from ..Aj import Aj
from ..Lj import Lj
        ...
        return \
            ...
            sp.Sum(
                sp.Sum(
                    ...
                    (i2, 1, m - 1)),
                (i1, 1, m - 1)) + \
            sp.Sum(G(b[:, i1], Lj(a, b, Aj(i, a, b, dxs), dxs), dxs) *
                   (J2(i1, dt, ksi) / 2 + dt * J1(i1, dt, ksi) + dt**2 / 2 * J0(i1, dt, ksi)) +
                   Lj(a, b, Lj(a, b, b[i, i1], dxs), dxs) * J2(i1, dt, ksi) / 2 -
                   Lj(a, b, G(b[:, i1], Aj(i, a, b, dxs), dxs), dxs) * (J2(i1, dt, ksi) + dt * J1(i1, dt, ksi)),
                   (i1, 1, m - 1)) + \
            sp.Sum(
                sp.Sum(
                    sp.Sum(
                        ...
                        G(b[:, i1], G(b[:, i2], G(b[:, i3], Aj(i, a, b, dxs), dxs), dxs), dxs) *
