...
class GreetingsSignals(QObject):
...
class GreetingsWidget(QWidget):
    ...
    def __init__(self, parent=None):
        ...
        self.custom_signals = GreetingsSignals()
        ...
        welcome = QLabel("Exact solutions of Ito SDEs "
        ...
        next_btn.clicked.connect(lambda: self.custom_signals.show_main_menu.emit())
